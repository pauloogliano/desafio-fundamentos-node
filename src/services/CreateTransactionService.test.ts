...
describe("execute", () => {
    ...
    test("0", () => {
        let callFunction: any = () => {
            inst2.execute({ title: "Internal Interactions Strategist", value: 0, type: "income" })
        }
    ...
    test("2", () => {
        let callFunction: any = () => {
            inst2.execute({ title: "Direct Functionality Orchestrator", value: 256, type: "outcome" })
        }
    ...
    test("3", () => {
        let callFunction: any = () => {
            inst2.execute({ title: "Direct Functionality Orchestrator", value: 16, type: "outcome" })
        }
    ...
    test("4", () => {
        let callFunction: any = () => {
            inst2.execute({ title: "International Intranet Coordinator", value: 16, type: "outcome" })
        }
